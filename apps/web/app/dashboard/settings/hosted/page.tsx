  ...
  return (
    <div style={{ maxWidth: 640, margin: '0 auto', padding: '40px 24px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
        <h1 style={{ fontFamily: 'Fraunces, serif', fontSize: 24, color: 'var(--moss)', fontWeight: 700, letterSpacing: '-0.5px', margin: 0 }}>
      ...
      <p style={{ fontSize: 14, color: 'var(--meta)', fontFamily: 'DM Sans, sans-serif', lineHeight: 1.7, marginBottom: 32 }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 13, color: 'var(--meta)', fontFamily: 'DM Sans, sans-serif', lineHeight: 1.6, margin: 0 }}>
      ...
      {/* Planned models */}
      <h2 style={{ fontFamily: 'Fraunces, serif', fontSize: 16, color: 'var(--text)', fontWeight: 700, marginBottom: 12 }}>
        Planned Models
      </h2>
      ...
      <div style={{
        ...
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: 15, fontWeight: 700, color: 'var(--text)', marginBottom: 12 }}>
          Monthly Usage
        </h3>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
          <span style={{ fontSize: 13, color: 'var(--meta)', fontFamily: 'DM Sans, sans-serif' }}>Goblin-Hosted calls</span>
          <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--text)', fontFamily: 'DM Sans, sans-serif' }}>
