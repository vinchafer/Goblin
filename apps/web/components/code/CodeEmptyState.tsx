    ...
    <div style={{
      ...
      {hasFiles ? (
        <>
          ...
          <p style={{ fontSize: 'var(--t-small-fs)', color: 'var(--ink-on-dark-2)', fontFamily: 'var(--font-sans)', maxWidth: 320, lineHeight: 1.55 }}>
        ...
        <>
          ...
          <p style={{ fontSize: 'var(--t-small-fs)', color: 'var(--ink-on-dark-2)', fontFamily: 'var(--font-sans)', maxWidth: 340, lineHeight: 1.6, marginBottom: 22 }}>
          ...
          <button
            ...
            style={{
              ...
              border: 'none',
              borderRadius: 10, padding: '10px 20px', fontSize: 'var(--t-small-fs)', fontWeight: 600,
