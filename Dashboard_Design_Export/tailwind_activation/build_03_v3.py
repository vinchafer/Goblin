...
def header():
    ...
    return (
      ...
      'flex-shrink:0;border-bottom:1px solid rgba(247,247,236,0.10);position:relative;z-index:50">'
        ...
        '<div style="position:relative;flex-shrink:0"><button aria-label="Create new" style="width:32px;height:32px;border-radius:50%;'
...
<html lang="de"><head><meta charset="utf-8"><title>built_03_v3 · Dashboard Home</title>
{FONTS_TAG}
<style>
...
<h1 class="exp-title">Screen 03 — Dashboard Home (corrective rebuild v3)</h1>
<p class="exp-sub">app/dashboard/page.tsx + Header + Sidebar · v3</p>
...
out = os.path.join(HERE, "built_03_v3.html")
